...
class BertEncoder(nn.Module):
    def __init__(self, cfg):
        ...
        self.bert_type = cfg.bert_type
        self.last_n_layers = cfg.last_n_layers
        self.aggregate_method = cfg.aggregate_method
        self.norm = cfg.norm
        self.embed_dim = cfg.embed_dim
        self.freeze_bert = cfg.freeze_bert
        self.agg_tokens = cfg.agg_tokens
    ...
    def forward(self, ids, attn_mask, token_type):
        ...
        word_embeddings = word_embeddings.view(batch_dim, num_words, self.embed_dim)
