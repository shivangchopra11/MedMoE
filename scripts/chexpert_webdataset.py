...
output_file = '/nethome/schopra47/nvme/bio/MedMoE/datasets/unimed/chexpert_webdataset/dataset-%06d.tar'
max_samples_per_shard = 10000

annotations = pd.read_csv(os.path.join(base_data_dir, 'CheXpert-v1.0-small', 'chexpert_with_captions_only_frontal_view.csv'))
